# fix_files.py — Rodar UMA vez para gerar main.py e corrigir inference.py
import os
...
# ============================================================
# src/detect/inference.py
# ============================================================
inference_py = """import random
import uuid
...
os.makedirs("src/detect", exist_ok=True)

with open("src/main.py", "w", encoding="utf-8") as f:
    f.write(main_py)
print("src/main.py ............. CRIADO")

with open("src/detect/inference.py", "w", encoding="utf-8") as f:
    f.write(inference_py)
print("src/detect/inference.py .. CORRIGIDO")
