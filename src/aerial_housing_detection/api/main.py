...
from src.aerial_housing_detection.api.routes.operational_features import (
    router as operational_features_router,
)
...
def create_app() -> FastAPI:
    ...
    app.include_router(operational_features_router)
